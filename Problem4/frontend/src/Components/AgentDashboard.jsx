    ...
    <>
      ...
      >
        ...
        <PerformanceCards
          ...
          value={performanceData.connected_calls}
        />
        <PerformanceCards
          title="Not Connected Calls"
          value={performanceData.not_connected_calls}
        />
        <PerformanceCards
          title="Inbound Calls"
          value={performanceData.inbound_calls}
        />
        <PerformanceCards
          title="Outbound Calls"
          value={performanceData.outbound_calls}
        />
        <PerformanceCards
          title="Missed Calls"
          value={performanceData.missed_calls}
        />
        <PerformanceCards
          title="User Busy Calls"
          value={performanceData.user_busy_calls}
        />
        <PerformanceCards
          title="Not Attended Calls"
          value={performanceData.not_attended_calls}
        />
      </div>
    </>
  );
